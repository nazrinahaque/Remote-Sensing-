// ============================================================
// HURRICANE MICHAEL — NDVI EXTRACTION AT PARCEL LEVEL
// Author: Nazrina Haque
// Description: Extracts mean NDVI difference for each parcel
//              using full 10m Sentinel-2 resolution
//              Exports parcel-level NDVI values as CSV
// ============================================================
...
// ============================================================
// 7. EXTRACT NDVI DIFFERENCE PER PARCEL (10m resolution)
// ============================================================
...
Export.table.toDrive({
  ...
  description: 'Parcels_NDVI_Difference_10m',
  fileFormat:  'CSV'
});
